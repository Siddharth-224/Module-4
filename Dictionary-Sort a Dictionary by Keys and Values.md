...
~~~
## Sample Output
--- Original Dictionary --- {'Zebra': 'Black', 'Apple': 'Red', 'Monkey': 'Brown', 'Banana': 'Yellow', 'Ocean': 'Blue'}

--- Sorted by Keys (Alphabetical) --- {'Apple': 'Red', 'Banana': 'Yellow', 'Monkey': 'Brown', 'Ocean': 'Blue', 'Zebra': 'Black'}

--- Sorted by Values (Alphabetical) --- {'Zebra': 'Black', 'Ocean': 'Blue', 'Monkey': 'Brown', 'Apple': 'Red', 'Banana': 'Yellow'}
## Result
